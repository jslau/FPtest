...
// BEGIN TP mary.mattern@trailerpark.com 11/11/2011
	if ( ((this.mrSlider.mCurrent % 5) == 0) && this.mrSlider.mCurrent != 0) {
	    document.getElementById("ad-wrapper").style.left = "0";
	    this.mrSlider.mrSlideshow.TogglePlay();
	    this.mSlideTimeout = set_timeout( this, '_RollSlideshow', '', SLIDESHOW_ROLL_TIMEOUT);
	    setTimeout("document.getElementById('ad-wrapper').style.left = '-999em'",4000);
	}
...
//	tmp.style.display		=	'none';
 ...
 {
 	var sharestr1				=	'<a class="button2" href="/sendtofriend.ftl?url=';
 	var sharestr2				=	'&amp;returnurl=';
 	var sharestr3				=	'">Share</a>';
